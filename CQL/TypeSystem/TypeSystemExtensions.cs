...
namespace CQL.TypeSystem
{
    ...
    {
        public static IExpression ApplyCast(this IEnumerable<CoercionRule> @this, IExpression expression, IScope context, Func<Exception> generateError = null)
        {
            if (!@this.Any())
            {
        ...
        public static Type AlignTypes(this IScope @this, ref IExpression lhs, ref IExpression rhs, Func<Exception> generateError)
        {
